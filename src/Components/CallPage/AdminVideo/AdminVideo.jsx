              ...
              {shareIsActive ? (
                <div className="share_div">
                  <div className="buttons">
                    <div
                      className={
                        share === "givePermission" ? "active" : "disabled"
                      }
                      onClick={() => setShareSetting("givePermission")}
                    >
                      Give permission
                      <i
                        className="fa-regular fa-key"
                        style={{
                          color:
                            share === "givePermission" ? "#0060FF" : "black",
                        }}
                      ></i>
                    </div>
                    <div
                      className={share === "allowMouse" ? "active" : "disabled"}
                      onClick={() => setShareSetting("allowMouse")}
                    >
                      Allow mouse use
                      <i
                        className="fa-regular fa-computer-mouse"
                        style={{
                          color: share === "allowMouse" ? "#0060FF" : "black",
                        }}
                      ></i>
                    </div>
                  </div>
